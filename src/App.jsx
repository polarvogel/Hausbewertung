...
/* Hauptkomponente der Anwendung. Verwaltet den globalen State, synchronisiert mit LocalStorage und orchestriert die UI-Bereiche. */
export default function App() {
    ...
    /* Aktualisiert ein einzelnes Feld innerhalb der Metadaten. */
    const updateMeta = useCallback((field, value) => {
        setMeta(prev => ({ ...prev, [field]: value }));
    }, []);

    /* Verarbeitet den Datei-Upload, konvertiert das Bild in einen Base64-String und speichert es im State. */
    ...
    /* Aktualisiert eine spezifische Eigenschaft eines Bewertungskriteriums anhand seines Index. */
    ...
    /* Aktualisiert exklusiv den KO- oder Gold-Status eines Kriteriums. Beide können nicht gleichzeitig aktiv sein. */
    ...
    /* Setzt alle Metadaten und Kriterien nach einer Sicherheitsabfrage auf ihre Ursprungswerte zurück. */
